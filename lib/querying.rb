...
def select_value_and_count_of_most_prolific_species
  "SELECT characters.species, MAX(spec_count) FROM characters GROUP BY characters.species HAVING (SELECT COUNT(characters.species) as spec_count FROM characters)"
end
